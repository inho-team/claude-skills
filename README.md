...
> [!IMPORTANT]
> **QE Framework v3.0.4** - Multi-model role orchestration, runner-based role mapping, stricter `/Qinit` role assignment confirmation, and external runner execution guidance for `/Qatomic-run` and `/Qcode-run-task`.
>
