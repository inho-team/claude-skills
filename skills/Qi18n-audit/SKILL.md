---
name: Qi18n-audit
description: Scans source files for hardcoded user-facing strings and generates translation keys. Use for i18n audit, translation check, hardcoded string detection, missing translation, i18n coverage, hardcoded strings, multilingual check, i18n audit. Distinct from Qdoc-converter (format conversion) — this scans .tsx/.ts/.jsx files for untranslated strings and replaces them with t('key') calls.
metadata: 
author: anthropic
version: 1.0.0
user_invocable: true
